...
> This project **must be run inside a Python virtual environment** to ensure isolation, reproducibility, and to prevent system Python contamination.
...
### 8. Run remaining TrainAI Drone YOLO steps
All training, testing, and inference steps in this guide **must be executed with the venv active**.
